...
const DiscountCode: React.FC<DiscountCodeProps> = ({ cart }) => {
  ...
  const checkGiftCard = useCallback(
    (code: string) => {
      mutate(
        {
          gift_cards: [
    ...
    [gift_cards, mutate, setCart, setError]
  )
  ...
  // useEffect(() => {
  //   const disCode = sessionStorage.getItem("discountCode")
  //   console.log("discountCode at checkout", disCode)
  //   if (disCode) {
  //     onApply({ discount_code: disCode })
  //   }
        ...
        {appliedDiscount ? (
          <div className="w-full flex items-center">
            <div className="flex flex-col w-full">
              ...
              <div className="flex items-center justify-between w-full max-w-full border border-green p-2 rounded-md bg-greenLight/50">
